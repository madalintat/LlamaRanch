...
pub fn catalog() -> &'static [CatalogEntry] {
    &[
        ...
        CatalogEntry { id: "gemma-3-4b", name: "Gemma 3 4B", description: "Google's capable 4B chat model, fits on GPU.", group: "chat", repo: "ggml-org/gemma-3-4b-it-GGUF", file: "gemma-3-4b-it-Q4_K_M.gguf", mmproj: None, approx_gb: 2.5 },
        ...
        CatalogEntry { id: "nomic-embed-1.5", name: "Nomic Embed Text v1.5", description: "Popular long-context text embeddings for RAG.", group: "embedding", repo: "nomic-ai/nomic-embed-text-v1.5-GGUF", file: "nomic-embed-text-v1.5.Q4_K_M.gguf", mmproj: None, approx_gb: 0.1 },
    ]
}
